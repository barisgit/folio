...
Describe the generated JSON index that documents the public Folio DSL surface, the build-time and CI guardrails that keep it fresh, and the `folio docs` command surface agents and humans use to read it.
