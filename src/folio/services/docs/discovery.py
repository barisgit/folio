...
from folio.services.docs.meta import DEFAULT_EXAMPLE_SETUP, DSL_KINDS
from folio.services.docs.schema import VALID_KINDS, Example, Param, Returns, Symbol
from folio.services.docs.source_info import public_module_for, resolve_source
...
def _describe_token(name: str, value: Any, *, tokens_module: Any) -> Symbol:
    from folio.services.docs.meta import TOKEN_DOCS  # noqa: PLC0415
...
def _describe_style(name: str, value: Any, *, tokens_module: Any) -> Symbol:
    from folio.services.docs.meta import STYLE_DOCS  # noqa: PLC0415
